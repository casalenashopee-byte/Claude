...
import type { FormState } from "@/actions/quotes";
    ...
    <form action={formAction} className="space-y-4 max-w-2xl">
      <div className="rounded-2xl border border-border bg-surface p-6 space-y-4">
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          <FieldGroup>
            <Label>Contato</Label>
            <Input name="contact" placeholder="Telefone ou e-mail" />
          </FieldGroup>
          <FieldGroup>
        ...
        <FieldGroup>
          ...
          <Input type="number" min="1" name="validityDays" defaultValue={7} className="w-32" />
        </FieldGroup>
      </div>
      ...
      <div className="rounded-2xl border border-border bg-surface p-6 space-y-3">
        ...
        <input type="hidden" name="items" value={JSON.stringify(items.filter((i) => i.name))} />
      ...
      <div className="rounded-2xl border border-border bg-surface p-6 space-y-3">
        ...
        <FieldGroup>
          ...
          <Textarea name="terms" rows={2} placeholder="Ex: 50% de entrada, prazo de entrega…" />
        </FieldGroup>
      </div>
      ...
      <div className="flex gap-2">
        ...
        <LinkButton href="/servicos?tab=orcamentos" variant="secondary">
          Cancelar
        </LinkButton>
      </div>
    </form>
